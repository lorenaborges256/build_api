...
class CompetitionSchema(ma.Schema):
    ...
    participations = fields.List(fields.Nested("ParticipationSchema", exclude=["competition"]))
    class Meta:
        fields = ("id", "title", "description", "prize", "year", "category_id", "category", "participations")
